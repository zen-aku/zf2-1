<?php
/*
 * Хелпер headmeta() предназначен для генерации <meta> тегов.
 * Для хранения он использует контейнер Zend\View\Helper\Placeholder\Container\AbstractContainer
 * Хелпер headmeta() представляет собой частный случай более универсального хелпера placeholder()
 */
/*
 * Способы добавления meta в контейнер Zend\View\Helper\Placeholder\Container\AbstractContainer
 */
/*
 * Первый способ добавления meta в хранилище - через __invoke() - meta добавляются в контейнер как числовые элементы массива
 * __invoke($content = null, $keyValue = null, $keyType = 'name', $modifiers = array(), $placement = Placeholder\Container\AbstractContainer::APPEND)
