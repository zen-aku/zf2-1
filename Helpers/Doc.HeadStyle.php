 ...
 * Позволяет встраивать  inline стили на страницу динамически, не ипользуя html-кода.
 * Но стили всё-равно надо прописывать явно в строковую переменную, что снижает применимость этого хелпера, учитывая его низкую производительность
 */
