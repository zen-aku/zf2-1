...
namespace MysqlGenerator\Metadata;
...
class Metadata implements MetadataInterface {
     ...
     */
    protected function createSourceFromAdapter(AdapterInterface $adapter) {       
     ...
     * @param string $schema
     * @return \MysqlGenerator\Metadata\Object\TriggerObject
     */
     ...
     * @param string $table
     * @param string $schema
     * @return \MysqlGenerator\Metadata\Object\ColumnObject
     */
