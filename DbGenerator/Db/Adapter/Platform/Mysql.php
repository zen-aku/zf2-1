...
//!!!	// нужна проверка на принадлежность драйвера к платформе mysql
        if (($driver instanceof Pdo\Pdo) ) {
            $this->resource = $driver;
            return $this;
        }
        throw new Exception\InvalidArgumentException('$driver must be MySQL PDO instance');
    }
