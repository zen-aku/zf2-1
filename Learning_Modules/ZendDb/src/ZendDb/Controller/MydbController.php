...
class MydbController extends AbstractActionController {
    ...
    function createAction() {
        ...
        // создание колонок через посредника без создания объектов через new
        //$column = $ddl->columnTable()->integer('art', true, 1, ['comment' => 'артикль']);
        //$create->addColumn($column1);
        $create->addColumn()->integer('art', true, 1, ['comment' => 'артикль']);
