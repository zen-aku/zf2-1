...
class IndexController extends AbstractActionController {
	...
	/**
	 * route: /helpers/index
	 * В его виде используется пользовательский хелпер displayCurrentDate()
	 */
    ...
    /**
	 * Пример с хелпером serverUrl()
	 * route: /helpers/index/serverurl
	 */
    function serverurlAction() {
		return new ViewModel(
			array()
		);
	}
    ...
    /**
	 * Пример с хелпером renderchildmodel()
	 * route: /helpers/index/renderchildmodel
	 */
    function renderchildmodelAction() {
		return new ViewModel(
			array()
		);
	}
    ...
    /**
	 * Пример с хелпером viewmodel()
	 * route: /helpers/index/viewmodel
	 */
