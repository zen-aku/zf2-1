<?php
/*
 * Пример создания контроллера с помощью фабрики контроллера FactoryControllerFactory
...
/**
 * Контроллер создаётся с помощью фабрики FactoryControllerFactory
 */
class FactoryController extends AbstractActionController {
	 ...
	 * внедряется при создании объекта этого контроллера с помощью фабрики FactoryControllerFactory
	 * @var object
	 */
	...
	/**
	 * Вызывается из FactoryControllerFactory для внедрения объекта класса-сервиса $service в контроллер FactoryController
